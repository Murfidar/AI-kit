...
2. If on `main`, `master`, `develop`, `dev`, `trunk`, or a release branch, create a task branch.
...
After verification passes, commit automatically. Use the project commit format when documented; otherwise use Conventional Commits.
